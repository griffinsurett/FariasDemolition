// src/components/LoopComponents/BeforeAfterSlider.jsx
...
export default function BeforeAfterSlider({
  ...
  return (
    <article
      ref={containerRef}
      className={`relative w-full overflow-hidden ring-1 ring-black/5 shadow-xl ${className}`}
    >
      {/* Mobile: aspect ratio container, Desktop: fixed height */}
      <div className="relative pb-[75%] md:pb-0 md:h-[58vh]">
        {/* Position absolute on mobile, relative on desktop */}
        <div className="absolute inset-0 md:relative md:w-full md:h-full">
